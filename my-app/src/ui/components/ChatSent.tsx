...
/*
 * Documentation:
 * Chat Sent — https://app.subframe.com/f183fbad57c0/library?component=Chat+Sent_8206bfc1-a590-434f-9706-c81a8bc60827
 */
      ...
      >
        <div className="flex flex-col items-start justify-center gap-1">
          ...
          <div className="flex w-full max-w-[576px] flex-col items-start gap-2 rounded-md bg-brand-600 px-3 py-2">
            {message ? (
              <span className="text-body font-body text-black">{message}</span>
            ) : null}
          </div>
        </div>
      </div>
